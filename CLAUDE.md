...
- **Never send more backspaces than we know we typed.** The clamp lives in exactly one place (`unicode::char_index_from_end`); a second one elsewhere would hide a broken first from the tests.
